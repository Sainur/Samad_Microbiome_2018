...
####edgR (Copepods)
kosticB = subset_samples(HJ_phyloseq_Poland_Copepods, group= "Temp_group")

kosticB
library("DESeq2")
packageVersion("DESeq2")  #‘1.24.0’


kosticp = subset_samples(kosticB, group= "Temp_group")
...
dge = phyloseq_to_edgeR(kosticB, group= "Temp_group")
...
pp_cop<- ggplot(sigtabgen, aes(x = Genus, y = logFC, color = Phylum)) + geom_point(size=6) + 
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust = 0.5))
  
pp_cop  

### edgR (Cladocerans)
kosticB = subset_samples(HJ_phyloseq_Poland_Cladocerans, group= "Temp_group")
...
x = sort(x, TRUE)
sigtabgen$Genus = factor(as.character(sigtabgen$Genus), levels = names(x))
pp_cla<- ggplot(sigtabgen, aes(x = Genus, y = logFC, color = Phylum)) + geom_point(size=6) + 
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust = 0.5))
  
pp_cla

###edgR (Bacterioplankton)
kosticB = subset_samples(HJ_phyloseq_Poland_Bacterioplankton, group= "Temp_group")
...
x = sort(x, TRUE)
sigtabgen$Genus = factor(as.character(sigtabgen$Genus), levels = names(x))
pp_BA<- ggplot(sigtabgen, aes(x = Genus, y = logFC, color = Phylum)) + geom_point(size=6) + 
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust = 0.5))
  
pp_BA  

### edgR (Phytoplankton)
kosticB = subset_samples(HJ_phyloseq_Poland_Phytoplankton, group= "Temp_group")
...
x = sort(x, TRUE)
sigtabgen$Genus = factor(as.character(sigtabgen$Genus), levels = names(x))
pp_PA<- ggplot(sigtabgen, aes(x = Genus, y = logFC, color = Phylum)) + geom_point(size=6) + 
  theme(axis.text.x = element_text(angle = -90, hjust = 0, vjust = 0.5))
